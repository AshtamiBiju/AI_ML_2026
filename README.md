...
| Day | Date       | Work Done |
|-----|------------|-----------|
| 5   | Aug 29, 2025 | • **DSA:** Solved Valid Anagram problem (Python). <br> • **DSA:** Solved Reverse String problem (Python). <br> • **AI/ML:** Implemented Logistic Regression on a dummy binary classification dataset using scikit-learn. |
| 4   | Aug 28, 2025 | • **DSA:** Solved Palindrome Number problem (Python). <br> • **DSA:** Solved Remove Duplicates from Sorted Array problem (Python). <br> • **AI/ML:** Practiced train-test split and Linear Regression on a small dummy dataset. |
